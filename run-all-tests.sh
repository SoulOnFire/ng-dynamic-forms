...
# Core tests
if run_test "test:core" "npx ng test @soulonfire/ng-dynamic-forms-core --code-coverage"; then
...
# UI Basic tests
if run_test "test:ui-basic" "npx ng test @soulonfire/ng-dynamic-forms-ui-basic --code-coverage"; then
...
# UI Bootstrap tests
if run_test "test:ui-bootstrap" "npx ng test @soulonfire/ng-dynamic-forms-ui-bootstrap --code-coverage"; then
...
# UI Foundation tests
if run_test "test:ui-foundation" "npx ng test @soulonfire/ng-dynamic-forms-ui-foundation --code-coverage"; then
...
# UI Ionic tests
if run_test "test:ui-ionic" "npx ng test @soulonfire/ng-dynamic-forms-ui-ionic --code-coverage"; then
...
# UI Material tests
if run_test "test:ui-material" "npx ng test @soulonfire/ng-dynamic-forms-ui-material --code-coverage"; then
...
if run_test "test:ui-ng-bootstrap" "npx ng test @soulonfire/ng-dynamic-forms-ui-ng-bootstrap --code-coverage"; then
...
if run_test "test:ui-ngx-bootstrap" "npx ng test @soulonfire/ng-dynamic-forms-ui-ngx-bootstrap --code-coverage"; then
...
# UI PrimeNG tests
if run_test "test:ui-primeng" "npx ng test @soulonfire/ng-dynamic-forms-ui-primeng --code-coverage"; then
