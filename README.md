...
[![Downloads](http://img.shields.io/npm/dm/@soulonfire/ng-dynamic-forms-core.svg)](https://npmjs.org/package/@soulonfire/ng-dynamic-forms-core)
...
```
npm i @soulonfire/ng-dynamic-forms-ui-material -S
```
...
```typescript
import { DynamicFormsMaterialUIModule } from "@soulonfire/ng-dynamic-forms-ui-material";
...
} from "@soulonfire/ng-dynamic-forms-core";
...
import { DynamicFormModel, DynamicFormService } from "@soulonfire/ng-dynamic-forms-core";
...
```
npm i @soulonfire/ng-dynamic-forms-ui-<library-name> -S
```
...
```typescript
import { AUTOCOMPLETE_OFF } from "@soulonfire/ng-dynamic-forms-core";
